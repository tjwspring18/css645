...
\citep{miller2009complex}. However, two core features are
that the system is non-decomposable, and that the system features cognitive
agents. The following sections detail how mechanization meets this description. 
...
\citep{farrell1998professionalization,farrell2001transnational}. A more
sophisticated representation of cognition that incorporates such
learning-from-others is needed.
