...
Things they don't capture: selection into war and deterrence, gdp / capita to
political structure, institutional culture and choice, network effects and
emulation
...
orthodox modeling strategies fail to capture international security competition
as a complex system and why agent-based modeling is needed. In support of these
claims, it ``agentizes'' the leading model of military mechanization and shows that the
results of doing cast doubt on it. Finally, it presents a
...
There are many candidates for the causes of mechanization. Inter-state
competition and war is one. States may choose choose mechanization policies 
...
of all states between 1979 and 2001. They conduct regression analysis to identify
the effect of covariates on mechanization. They conclude that out of the
...
There is reason to believe that the orthodox multivariate statistical modeling 
approach employed in \citet{sechser2010army} is insufficient and leads to
incorrect conclusions. 

One, from a statistical perspective, the ability of the model in
\citet{sechser2010army} to produce reliable insight is questionable.
